...
function hero () {
  ...
  return (
    <div className="heroSection w-screen bg-secondery_blue pb-5 ">
      <div className="container lg:h-620 lg:w-screen bg-[url('https://cdn.discordapp.com/attachments/1061493503059824660/1067122134431838319/Untitled_design.png')] mx-auto">
        <nav className="text-2x lg:w-3/4 h-20 mx-auto flex justify-between text-white px-5 bg-secondery_blue">
          <div className="container flex flex-wrap items-center justify-between mx-auto">
            <a href="https://flowbite.com/" className="flex items-center">
              ...
              <svg
                ...
                height="34"
                viewBox="0 0 124 34"
                className="logo-3oeRIY text-white"
              >
                <g fill="currentColor">
            ...
            <button
              ...
              type="button"
              className="inline-flex items-center p-2 ml-3 text-sm text-white rounded-lg md:hidden hover:bg-primary_blue focus:outline-none focus:ring-2 focus:ring-gray-200"
        ...
        <div className="hero  text-center text-white 	">
          <h1 className="font-ginto xs:font-normal font-black text-3xl sm:text-5xl lg:mt-20 md:text-7xl ">
            IMAGINE A PLACE...
          </h1>

          <p className=" w-4/5  sm:w-2/4 mx-auto mt-10 text-lg sm:text-base">
        ...
        <div className="mx-auto mt-10 flex justify-center align-middle gap-5 text-lg">
          <button
            type="button"
            className="bg-white hover:text-blue-700 text-black font-bold py-2 rounded-full px-8"
          >
          ...
          <button
            type="button"
            className="bg-black hover:bg-gray-800 text-white font-bold py-2 rounded-full px-8"
          >

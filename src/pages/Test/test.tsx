  ...
  <div className="flex flex-col min-h-screen h-screen px-2 py-2 w-16">
    <div className="overflow-y-auto">
      <ul className="text-center">
        ...
        <li className="border-b border-gray-850 border-2 mx-3 mt-3" />
        <li className="mt-3">
          <a href="#">
            <img
        ...
        <span
          style={{ position: 'absolute', top: 142, left: '-10px' }}
        ...
        <li className="border-b border-gray-800 border-2 mx-3 mt-3" />
        <li className="mt-3">
          <a
            href="#"
            className="w-12 h-12 bg-gray-775 hover:bg-green-500 text-green-500 hover:text-white inline-block rounded-full"
        ...
        <div className="flex items-center">
          ...
          <a href="#" className="ml-4">
            <form action="#" className="relative">
              ...
              />
              <span className="absolute right-0 top-0 mr-1" style={{ top: 6 }}>
                <svg
            ...
            <div className="flex ml-6 my-3 py-4 border-t border-gray-700">
              ...
              <div className="ml-5">
                <div>
                  ...
                  <span className="text-xs text-gray-600 ml-1">12/31/2029</span>
                </div>
                <div>
            ...
            <div className="flex ml-6 my-3 py-4 border-t border-gray-700">
              ...
              <div className="ml-5">
                <div>
                  ...
                  <span className="text-xs text-gray-600 ml-1">1/1/2030</span>
                </div>
                <div>
                  <div>Placeholder text</div>
                  <div>Placeholder text number two</div>
          ...
          <div className="bg-gray-775 h-24 flex items-center mx-3">
            ...
            <div className="px-2 py-2 bg-gray-725 rounded-r flex items-center justify-between h-10">
              ...
              <button className="h-10 mr-2 bg-gray-725 rounded-l text-gray-500 hover:text-white">
                <div
                  style={{
                    backgroundImage: 'url(./static/icon_discord_emojis.png)',
